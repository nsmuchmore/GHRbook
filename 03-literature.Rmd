...
```{block, type='rmdshiny'}
Exploring meta-analysis ([link to full browser app](https://globalhealthresearch.shinyapps.io/meta-analysis-app/))
```

```{r shiny_ma, echo=F}
knitr::include_app("https://globalhealthresearch.shinyapps.io/meta-analysis-app/", height = "600px")
```
...
Let's come back to our helpful mnemonic PICO introduced in the previous chapter. PICO can help you create a good clinical question: [PICO](http://guides.mclibrary.duke.edu/c.php?g=158178&p=1035882).
