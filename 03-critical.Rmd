...
Scholars in every discipline have their own ways of reading and evaluating the literature. In medicine, this process is called **critical appraisal** and it's part of a larger approach called **evidence-based medicine** (EBM) or, more generally, **evidence-based practice** (EBP). 
...
```{block, type='rmdplay'}
Risk of bias and confounding ([PDF slide deck](https://drive.google.com/open?id=0Bxn_jkXZ1lxuNW1XM21PT1ZQTGM))
```

```{r ch3bias, echo=F}
knitr::include_url("https://warpwire.duke.edu/w/SFYBAA/")
```
...
```{r CH03quiz, echo=F}
knitr::include_url("https://duke.qualtrics.com/SE/?SID=SV_a33UqRjZErKqRLf",
height="1000px")
```
