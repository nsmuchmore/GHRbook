...
```{block, type='rmdplay'}
The fundamental challenge of causal inference ([PDF slide deck](https://drive.google.com/open?id=0Bxn_jkXZ1lxubkpSdUd2M2RON1k))
```
...
```{r deaton, echo=F}
knitr::include_url("https://www.youtube.com/embed/yiqbmiEalRU")
```
